    ...
    <section className="blog-area pt-120 pb-120">
      <div className="container">
        <div className="row g-4">
          ...
          >
            <div className="blog__item">
              ...
              <div className="blog__content">
                ...
                <h3>
                  <Link href="blog-details" className="primary-hover">
                    Necessity May Give us Best Virtual Court
                  </Link>
                </h3>
                <Link className="mt-25 read-more-btn" href="blog-details">
          ...
          >
            <div className="blog__item">
              <Link href="blog-details" className="blog__image image d-block">
          ...
          >
            <div className="blog__item">
              ...
              <div className="blog__content">
                ...
                <h3>
                  <Link href="blog-details" className="primary-hover">
                    Powerful Server and Platform Global Solution
                  </Link>
                </h3>
                <Link className="mt-25 read-more-btn" href="blog-details">
                  Read More <i className="fa-regular fa-arrow-right-long"></i>
