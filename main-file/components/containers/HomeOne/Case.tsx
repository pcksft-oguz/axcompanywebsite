            ...
            <div>
              <div className="case__item">
                ...
                <div className="case__content">
                  <span className="primary-color sm-font">AI Solution</span>
                  <h3>
                    <Link
                      href="case-details"
          ...
          <SwiperSlide>
            <div>
              <div className="case__item">
                ...
                <div className="case__content">
                  <span className="primary-color sm-font">ML Model</span>
                  <h3>
                    <Link
                      href="case-details"
                      className="text-white primary-hover"
          ...
          <SwiperSlide>
            <div>
              <div className="case__item">
                ...
                <div className="case__content">
                  <span className="primary-color sm-font">Data Science</span>
                  <h3>
                    <Link
                      href="case-details"
                      className="text-white primary-hover"
          ...
          <SwiperSlide>
            <div>
              <div className="case__item">
                ...
                <div className="case__content">
                  <span className="primary-color sm-font">AI Automation</span>
                  <h3>
                    <Link
                      href="case-details"
                      className="text-white primary-hover"
